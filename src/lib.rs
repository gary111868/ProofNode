...
#[derive(Debug)]
pub struct ProofNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProofNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProofNode processing");
    
    let mut processor = ProofNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProofNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProofNodeProcessor::new(false);
